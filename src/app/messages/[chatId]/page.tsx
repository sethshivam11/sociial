      ...
      case "location":
        return (
          <Link href={content} target="_blank">
            <NextImage
              src={`https://maps.gomaps.pro/maps/api/staticmap?center=${content.split("?q=")[1]
                }&zoom=15&size=240x240&markers=${content.split("?q=")[1]}&key=${process.env.NEXT_PUBLIC_MAPS_API_KEY
                }`}
              alt=""
