...
function Suggestions() {
  ...
  return (
    <div className="py-8 px-2 xl:flex hidden flex-col gap-4 xl:col-span-3">
      <div className="rounded-lg flex items-center justify-center bg-stone-200 dark:bg-stone-800 px-3 focus-within:ring-2 focus-within:ring-stone-700 dark:focus-within:ring-stone-300 peer">
        <Search className="inline bg-stone-200 dark:bg-stone-800" />
        <Input
          placeholder="Search"
          inputMode="search"
          className="bg-stone-200 dark:bg-stone-800 focus-visible:ring-0 focus-visible:ring-offset-0"
          onFocus={() => setSearchOpen(true)}
        />
      </div>
      <div
        className={`bg-stone-200 dark:bg-stone-800 ring-1 ring-stone-500 py-3 px-2 rounded-2xl ${
      ...
      <div className="bg-stone-200 dark:bg-stone-800 pt-4 pb-6 px-6 rounded-2xl">
